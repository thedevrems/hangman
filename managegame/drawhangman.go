...
func DrawHangman(dataFiles *configuration.DataFiles, dataGame *configuration.DataGameHangman, dataTranslation *configuration.TranslationHangman, dataError *configuration.DataError, pos int) {
