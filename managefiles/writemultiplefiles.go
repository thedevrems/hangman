...
func WriteMultipleFiles(dataFiles *configuration.Structure_files, dataError *configuration.Structure_error, dataTranslation *configuration.TranslationHangman, path string, fileNames []string, englishDetected bool) {
